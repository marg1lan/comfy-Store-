...
import image1 from "../../assets/earphones11.png";
import image2 from "../../assets/earphones22.png";
import image3 from "../../assets/earphones33.png";
import card1 from "../../assets/cardd2.png";
import card2 from "../../assets/card2.png";
import card3 from "../../assets/card3.png";

function Earphones1() {
  const [earphones, setHeadphones] = useState([]);
  useEffect(() => {
  ...
  return (
    <>
      <div className="hero_one flex items-center jutify-between mt-[160px]">
        <div className="img">
          <Link className="btn btn-primary text-slate-200" to="/">Go Back</Link>
          <img src={erarphones} alt="" className="mt-20" />
        </div>
        <div className="descriptions w-[445px]">
          <p className="text-orange-600 line ">NEW PRODUCT</p>
          <h2 className="text-5xl mb-4">{earphones?.name}</h2>
          <p className="mb-4">{earphones?.description}</p>
          <div className="flex items-center gap-8">
            ...
            <span onClick={handleCard} className="bg-orange-600 p-3 text-base-300 hover:bg-[#FBAF85] cursor-pointer">
            ADD TO CART
            </span>
          </div>
        </div>
      ...
      <div className="images mt-[160px] flex items-center w-[1109px] gap-[30px]">
        <div className="imagess">
          <img className = 'image mb-[32px]'  src={image1} alt="" />
      ...
      <div className="cards_container mb-[300px]">
        ...
        <div className="cards_card w-1/3 text-center">
          ...
          <div className="cards_card w-1/3 text-center">
              ...
              <Link to='/speakers1' className="btn w-32 bg-orange-600 p-3 text-base-300 hover:bg-[#FBAF85] cursor-pointer">
              See Product
            </Link>
            </div>
        </div>
