...
import headphones2 from "../../assets/speakerarsss.png";
import FirstFotter from '../../components/firstFotter'
import Cart from '../../components/cart'
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import image1 from "../../assets/img11.png";
import image2 from "../../assets/img22.png";
import image3 from "../../assets/img33.png";
import card1 from "../../assets/speakers55.png";
import card2 from "../../assets/cardd2.png";
import card3 from "../../assets/spek.png";

function Speakers2() {
  const [speakers, setHeadphones] = useState([]);
  useEffect(() => {
      ...
      <div>
        <div className="hero_one flex items-center jutify-between mt-[160px]">
          ...
          <div className="descriptions w-[445px]">
            ...
            <h2 className="text-5xl mb-4">{speakers?.name}</h2>
            <p className="mb-4">{speakers?.description}</p>
        ...
        <div className="descriptions flex w-[1109px]">
          ...
          <div className="desc2 ">
            ...
            <p>
              <span className="text-orange-600 mr-3">2x</span>Replacement
              Earcups
            </p>
            <p>
            ...
            <p>
              <span className="text-orange-600 mr-3">1x</span>3.5mm 5m Audio
              Cable
            </p>
          </div>
        </div>
        ...
        <div className="cards_container mb-[300px]">
          ...
          <div className="cards flex items-center jutify-between">
            <div className="cards_card w-1/3 text-center">
              ...
              <h3 className="mt-8 mb-8 text-2xl text-bold">ZX7 SPEAKER</h3>
              <Link
                to="/speakers2"
